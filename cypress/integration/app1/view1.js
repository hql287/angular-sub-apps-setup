describe('App1 View 1', () => {
  ...
  // Current Page
  it(`Should display page title as 'App1 View 1'`, () => {
  ...
  it(`Should go to App2 View 1 when click to 'App 2' button`, () => {
    cy.getSwitchApp2Btn().click();
    cy.url().should('include', '/app2/one')
    cy.url().should('include', 'http://localhost:8080/app2/one')
  });

  it(`Should go to back to App1 View 1 when click to 'App 1' button`, () => {
    cy.getSwitchApp2Btn().click();
    cy.url().should('include', '/app2/one')
