describe('App2 View 2', () => {
  ...
  // Current Page
  it(`Should display page title as 'App2 View 2'`, () => {
    cy.getSubAppViewTitle().should('eq', 'App2 View 2');
  });

  // Navigate between Pages
  it(`Should go to App2 View 1 when click to 'View One' button`, () => {
    cy.getSubAppNavView1Btn().click();
    cy.getSubAppViewTitle().should('eq', 'App2 View 1');
  });

  it(`Should go back to App2 View 2 when click to 'View Two' button`, () => {
    cy.getSubAppNavView1Btn().click();
